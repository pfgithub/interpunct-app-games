NOTES:
- switch to hono
- auto-register commands? maybe
- consider using the discord js raw thing for sending discord requests to handle timeouts

requires ngrok for localhost proxy

- ngrok free requires changing app settings all the time
